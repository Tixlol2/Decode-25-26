...
@Autonomous(name = "Close Helper")
public class CloseHelper extends NextFTCOpMode {
...
//                .setTangentHeadingInterpolation()
    ...
    public void onStartButtonPressed() {
        ...
        shootPath = new FollowPath(shortShootPathSupplier.get());
...
//                        OuttakeSubsystem.INSTANCE.SetFlywheelState(OuttakeSubsystem.FlywheelState.INTERPOLATED),
        ...
        intakeAndScoreClose = new SequentialGroup(
                IntakeSubsystem.INSTANCE.setActiveStateCommand(IntakeSubsystem.IntakeState.IN),
                new ParallelDeadlineGroup(new Delay(1.5), new FollowPath(closeIntakePath.get())),
...
//                            new ParallelDeadlineGroup(new Delay(.8), new FollowPath(bumpLever.get())),
        ...
        OuttakeSubsystem.lazyRPM = shortVelo;
        setAutoState(0);
    }
            ...
            case 4:
                if(oldState != autoState){
                    ...
                    new ParallelGroup(
                            ...
                            new FollowPath(parkClosePathSupplier.get()),
                            SetAutoState(-1)
                    ).schedule();
                }
                break;
